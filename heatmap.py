...
def main():
    ...
    parser.add_argument("--save_path",type=str,default="ours")
    parser.add_argument("--id",type=int,default=0)
    parser.add_argument("--x",type=float,default=0)
    parser.add_argument("--z",type=float,default=0)
    parser.add_argument("--bolb",type=float,default=0.6)
    ...
    obs=env.render()
    torch.save(obs, os.path.join(save_path,"obs"+str(id)+".pt"))
    rgb=obs[:,:,:3].astype(np.uint8)
    cv2.imwrite(os.path.join(save_path,"rgb"+str(id)+".png"),rgb)
